...
<div class="wrap">
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="jmenoLogin"
                   value="" placeholder="Jmenoo" required>
            <small id="emailHelp" class="form-text text-muted">(Jmeno nebo prezdivka)</small>
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Password</label>
            <input type="password" class="form-control" id="exampleInputPassword1" name="hesloLogin" value=""
                   placeholder="Heslo" required>
        </div>
        <div class="form-group form-check">
            <input type="checkbox" class="form-check-input" id="exampleCheck1">
            <label class="form-check-label" for="exampleCheck1">Zapamatovat</label>
        </div>
